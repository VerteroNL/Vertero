  ...
  return (
    <main className="min-h-screen bg-[#07070f] flex flex-col items-center justify-center p-6">
      ...
      <div className="w-full max-w-sm bg-[#0d0d1c] border border-white/10 rounded-2xl p-8">
        <h1 className="text-2xl font-extrabold tracking-tight text-white mb-1 text-center">Inloggen</h1>
        <p className="text-white/40 text-sm text-center mb-6">Welkom terug</p>
